...
uc8 DiskDevInfo_2M[]={"2MB Internal"};
u8  HDW_Ver[6] = "V2.60";
u8  DFU_Ver[6] = "V3.10";
u8   VerStr[8];
u8   Clash = 0;
...
u32 Set(u8 Object, u32 Value)
{
  ...
  case FPGA_RST:    GPIOB_CRH &= 0xF0FFFFFF;  GPIOB_CRH |= 0x01000000;        // ��PB14Ϊ���״̬
                    ...
                    GPIOB_CRH &= 0xF0FFFFFF;  GPIOB_CRH |= 0x08000000; break; // ��PB14Ϊ����״̬ 
...
u32 Get(u8 Object, u32 Value)
{
  ...
  case FIFO_DIGIT:  FIFO_H_L_LOW();  return (*(vu16 *)0x64000000); // 16bits FIFO Digital data
	...
	case FIFO_READY:  FIFO_H_L_LOW();  return ((*(vu16 *)0x64000000& 0x04)>> 2);    // Ready = Bit2
  ...
  case FIFO_START:  FIFO_H_L_LOW();  return ((*(vu16 *)0x64000000& 0x20)>> 5);		// Start=Bit5
  ...
  case VERTICAL:    return (u32)Y_ATTR;              // ��ֱͨ������ָ��
    
  case HORIZONTAL:  return (u32)X_ATTR;              // ˮƽͨ������ָ��
    
  case GLOBAL:      return (u32)G_ATTR;              // ��������ָ��
  
    
  case TRIGGER:     return (u32)T_ATTR;              // ����ͨ������ָ��
  ...
  case DFUVER:      Ver = __Chk_DFU();               // DFU�̼��汾��Ϣ
...
//                    else return (Ver[0]-'0')*100 +(Ver[2]-'0')*10 +(Ver[3]-'0'); 
  ...
  case HDWVER:      Ver = __Chk_HDW();               // �豸Ӳ���汾��Ϣ
//                    if(Ver == 0)  Ver = (u8*)(HDW_Ver + 13);
//                    if(Value == 0) return (u32)Ver;
//                    else return (Ver[0]-'0')*100 +(Ver[2]-'0')*10 +(Ver[3]-'0'); 
                    if(Ver == 0) Ver = HDW_Ver;
                    return (u32)Ver;
  case SYSVER:      Ver = (u8*)SYS_Ver;              // SYS����ģ��汾��Ϣ
                    if(Value == 0) return (u32)Ver;
                    else return (Ver[0]-'0')*100 +(Ver[2]-'0')*10 +(Ver[3]-'0'); 
  case FPGAVER:     FIFO_H_L_LOW();  
                    Data = (*(vu16 *)0x64000000)>> 6; // FPGA���ó���汾��Ϣ
